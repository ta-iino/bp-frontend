...
class ApproachModule extends BaseApiFactory {
  private urls: any = {
  ...
  async getSendCompanyHisotry(buyneedsMatchingHistoryId: Number) {
    ...
    return this.call(this.urls.getSendCompanyHisotry, this.baseURL, this.options);
  }
  ...
  async getBuyneedsMatchingResultCsv(buyneedsMatchingHistoryId: Number) {
    ...
    return this.call(this.urls.getBuyneedsMatchingResultCsv, this.baseURL, this.options);
  }
  ...
  async getBuyneedsMatchingResult(sendCompanyHistoryId: Number) {
    ...
    return this.call(this.urls.getBuyneedsMatchingResult, this.baseURL, this.options);
  }
  ...
  async startBuyneedsMatching(dmListId: Number) {
    ...
    return this.call(this.urls.startBuyneedsMatching, this.baseURL, this.options);
  }  
}
